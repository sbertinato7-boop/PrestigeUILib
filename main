...
-- ========================================
-- Copy everything below and use: loadstring(game:HttpGet("your_url"))()
-- This creates a global PrestigeUI table you can use
...
function PrestigeUI:Create(title)
    ...
    MinimizeBtn.MouseEnter:Connect(function()
        TweenService:Create(MinimizeBtn, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
            BackgroundColor3 = Color3.fromRGB(20, 200, 255)
        }):Play()
    end)
...
function PrestigeUI:AddTab(tabName)
    ...
    TabBtn.BackgroundColor3 = self.ActiveTab == nil and self.Theme.Primary or self.Theme.Tertiary
    TabBtn.Text = tabName
    ...
    Content.Visible = (self.ActiveTab == nil)
    ...
    self.Tabs[tabName] = {Button = TabBtn, Content = Content, Name = tabName}
    return Content
end
...
function PrestigeUI:AddDropdown(parent, placeholder, options, callback)
    ...
    for _, option in pairs(options) do
        ...
        OptionBtn.MouseEnter:Connect(function()
            TweenService:Create(OptionBtn, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
                BackgroundColor3 = self.Theme.Primary
            }):Play()
        end)
...
-- Make PrestigeUI global so it can be accessed after loadstring
_G.PrestigeUI = PrestigeUI

print("✓ Prestige UI Library Loaded!")
